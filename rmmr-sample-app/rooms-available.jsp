...
<body>
    ...
    <script>
        $(document).ready(function() {
          ...
          var apiEndpoint = 'https://b1771805-d0ae-4ce9-b5c8-2a10cd888fae-prod.e1-us-cdp-2.choreoapis.dev/xnkj/rmmrservices/endpoint-8080-5c6/v1.0/get_rooms_available';
     ...
     // attributesDiv.html('<p>Access Token: ' + response.access_token + '</p>');
      ...
      $.ajax({
        ...
        success: function(roomsResponse) {
          ...
          tableHTML += '<tr><th>Room ID</th><th>Room Name</th><th>Capacity</th><th>Location</th><th>Status</th><th>Available</th><th>Capacity</th></tr>';
